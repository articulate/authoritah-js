...
exports.cli = function (args) {
  ...
  (0, _versionParser2.default)().then(cli.version.bind(cli)).then(setupCLI).then(addSetupCommand).then(addConfigCommand).then(addJwtCommand).then(addDumpCommand).then(addApplyCommand).then(addDiffCommand).then(function (cli) {
