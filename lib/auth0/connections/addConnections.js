...
function addConnections(context) {
  ...
  var createFn = function createFn(obj) {
    return client.connections.create((0, _prepareConnectionForCreate2.default)(obj)).then(print).catch((0, _apiErrorHandler2.default)("creating connection", obj, context));
  };
