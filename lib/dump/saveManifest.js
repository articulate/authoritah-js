...
var transformations = {
  rules: _ramda2.default.map(_ramda2.default.omit(['id'])),
  connections: _ramda2.default.map(_ramda2.default.compose(filterOptions, _ramda2.default.omit('id'))),
  clients: _ramda2.default.map(_ramda2.default.omit(['client_id']))
};
