...
var isArrayPair = _ramda2.default.unapply(_ramda2.default.all(_ramda2.default.is(Array)));
var notObjectPair = _ramda2.default.compose(_ramda2.default.not, _ramda2.default.unapply(_ramda2.default.all(_ramda2.default.is(Object))));
...
var deepMerge = _ramda2.default.mergeWith(function (lhs, rhs) {
  return _ramda2.default.isEmpty(lhs) || isArrayPair(lhs, rhs) || notObjectPair(lhs, rhs) ? lhs : deepMerge(lhs, rhs);
});
