...
var sortByName = _ramda2.default.sortBy(_ramda2.default.prop('name'));

function saveConnections(context) {
  var connections = context.connections,
      connectionScripts = context.options.connectionScripts;


  var saveAndWrite = _ramda2.default.map(function (connection) {
    var name = connection.name,
        customScripts = connection.options.customScripts;
  ...
  return _ramda2.default.assoc('connections', _ramda2.default.compose(sortByName, saveAndWrite)(connections), context);
}