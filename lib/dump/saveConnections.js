...
var _objectManipulation = require('../utils/objectManipulation');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var scriptPath = ['options', 'customScripts'];
var ruleLens = _ramda2.default.lens(_ramda2.default.path(scriptPath), _ramda2.default.assocPath(scriptPath));
