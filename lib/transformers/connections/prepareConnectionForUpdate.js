...
var filterUpdateFields = _ramda2.default.omit(['name', 'strategy', 'id']);
var prepareConnectionForUpdate = _ramda2.default.compose(filterUpdateFields, _prepareConnectionForCreate2.default);
