...
var deepMerge = _ramda2.default.mergeWith(function (l, r) {
  return _ramda2.default.is(Array, l) && _ramda2.default.is(Array, r) ? _ramda2.default.concat(l, r) : !(_ramda2.default.is(Object, l) && _ramda2.default.is(Object, r)) ? r : deepMerge(l, r);
});
...
var changes = function changes(filter) {
  ...
  }), _ramda2.default.map(_ramda2.default.reverse), findChanges(filter), groupByUuid);
};
