...
function associate(context) {
  ...
  var retrieveIds = _ramda2.default.compose(_ramda2.default.pluck('name'), findAllIn(clients, 'client_id'));
...
function disassociate(context) {
  ...
  var retrieveIds = _ramda2.default.compose(_ramda2.default.pluck('client_id'), findAllIn(clients, 'name'));
  var associateClient = _ramda2.default.over(_ramda2.default.lensProp('enabled_clients'), retrieveIds);
