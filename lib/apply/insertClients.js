...
function insertClients(context) {
  ...
  var filtered = _ramda2.default.compose(_ramda2.default.filter(missingIds), _ramda2.default.values, _ramda2.default.map(_ramda2.default.mergeAll), _ramda2.default.filter(pairNotEqual), groupByName)(server, local);
